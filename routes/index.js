...
router.get('/', function (req, res) {
  res.render('index', { title: 'ChickenDish App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'ChickenDish App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'ChickenDish App Login', user: req.user });
});
